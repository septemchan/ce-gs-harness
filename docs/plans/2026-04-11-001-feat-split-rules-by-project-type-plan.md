...
- [x] **Unit 1: Split workflow-map into two files**
...
- [x] **Unit 2: Update harness-audit init mode with project type detection**
...
- [x] **Unit 3: Update harness-audit audit mode with version check and type mismatch**
